...
# buying a lottery (you have to set your own number)
try:
    driver.get('https://el.dhlottery.co.kr/game/TotalGame.jsp?LottoId=LP72')
    iframe = driver.find_element(By.XPATH, value = '//*[@id="ifrm_tab"]')
    driver.switch_to.frame(iframe)
    driver.find_element(By.XPATH, value = '//*[@id="frm"]/div/ul[3]/li[5]/span/a').click()
    time.sleep(1)
    driver.find_element(By.XPATH, value = '//*[@id="lotto720_popup_my_number"]/div/div[2]/ul/li[1]/a[1]/span').click()
    time.sleep(1)
    driver.find_element(By.XPATH, value='//*[@id="lotto720_popup_my_number"]/div/div[3]/a/span').click()
    time.sleep(1)
    driver.find_element(By.XPATH, value = '//*[@id="frm"]/div/ul[4]/li[5]/a').click()
    time.sleep(1)
    da = Alert(driver)
    da.accept()
    driver.find_element(By.XPATH, value = '//*[@id="lotto720_popup_confirm"]/div/div[3]/a[1]/span').click()
    time.sleep(1)
    driver.find_element(By.XPATH, value = '//*[@id="lotto720_popup_pay"]/div/div[3]/a/span').click()
    time.sleep(1)
